...
type CreateUndergraduateStudentInCourseDialogProps = {
  courseCode: number
}

export function CreateUndergraduateStudentInCourseDialog({
  courseCode,
}: CreateUndergraduateStudentInCourseDialogProps) {
